...
class ForgetPasswordOtpEmail extends Mailable implements SettingableMail
{
    ...
    public function build()
    {
        ...
        $setting['body'] = str_replace('{{otp_expire_duration}}',(is_null(secondsToHumanReadable(getSetting("USER_FORGOT_PASSWORD_OTP_DURATION"))) || empty(secondsToHumanReadable(getSetting("USER_FORGOT_PASSWORD_OTP_DURATION")))) ? 'Unknown': secondsToHumanReadable(getSetting("USER_FORGOT_PASSWORD_OTP_DURATION")),$setting['body']);
