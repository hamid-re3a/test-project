...
class PasswordResetEmail extends Mailable implements SettingableMail
{
    ...
    {
        return getEmailAndTextSetting('USER_PASSWORD_HAS_BEEN_RESET_BY_ADMIN_REQUEST') ;
    }
}
